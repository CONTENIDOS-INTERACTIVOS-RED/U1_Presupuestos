        ...
        .row.g-0
          ...
          .col-xl-6.info-section
            .content-wrapper.px-lg-4.pt-lg-4.px-xxl-5.py-xxl-5.text-start
              ...
              p.descripcion.mb-4 El presupuesto es una herramienta clave en la gestión financiera, permitiendo planificar y controlar ingresos y gastos para optimizar recursos. Su estructura incluye ingresos, gastos y ahorros, con tipos como operativo, de capital y flexible. Es dinámico, ajustándose a cambios internos y externos. Su propósito abarca planificación, control y toma de decisiones estratégicas. Se clasifica en operativo y de capital, cada uno con funciones específicas. La planeación y control del presupuesto garantizan estabilidad financiera, permitiendo evaluar desviaciones y realizar ajustes para alcanzar los objetivos organizacionales de manera sostenible.
